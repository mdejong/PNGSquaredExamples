...
TheElements demo modified to add a new build target with PNGSquared compression for the PNG
image assets. The compression reduces the image size from about 235 kB to 70 kB.
